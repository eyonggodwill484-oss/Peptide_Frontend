...
`;
  ...
  fs.writeFileSync('f:/Bobbin/Peptide_Frontend/Frontend/src/lib/data/sarms-products.ts', fileContent, 'utf8');
  console.log('Successfully generated sarms-products.ts with all 16 SARMs and their price points!');
}
